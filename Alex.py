...
def resize_img(data):
	...
	print('data_upscale:', data_upscale.shape[1:])
	return data_upscale
...
class cnn_min_batch_GD():
	...
	def Alexnet(self):
		...
		model.add(Conv2D(96,(11,11),strides=(4,4),input_shape=(32,32,3),padding='valid',activation='relu',kernel_initializer='uniform'))
...
# 	(options, args) = parser.parse_args()
	options = {"model":"alexnet", "opt":"adam", "data_aug":"false"}
	print(options)
